...
def get_recommendations(user_id: int, product_history: List[int]):
  ...
  },
  {
    ...
    githubUrl: githubRepo('healthscan'),
  ...
  },
  {
    ...
    githubUrl: githubRepo('resume-tailor'),
    status: 'Completed',
    year: 2025,
    category: 'Full-Stack',
...
def analyze_job_description(job_text: str) -> Dict:
  ...
  },
  {
    ...
    githubUrl: githubRepo('blinds_pro'),
  ...
  },
  {
    ...
    githubUrl: githubRepo('railway_predictive_frontend'),
    status: 'Production',
    year: 2024,
    category: 'AI/ML',
  ...
  },
  {
    ...
    githubUrl: githubRepo('auto-loan-processing'),
  ...
  },
  {
    ...
    githubUrl: githubRepo('fitness-transformation-app'),
  ...
  },
  {
    ...
    githubUrl: githubRepo('ai-job-hunter'),
  ...
  },
  {
    ...
    githubUrl: githubRepo('Taskify-pro'),
    status: 'Completed',
    year: 2023,
    category: 'Full-Stack',
  ...
  },
  {
    ...
    githubUrl: githubRepo('lahariKarrotu'),
    status: 'Completed',
    year: 2023,
    category: 'Full-Stack',
